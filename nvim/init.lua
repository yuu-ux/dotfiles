...
vim.keymap.set("x", ">", ">gv", { noremap = true, silent = true, desc = "Indent selected lines to the right and reselect" })
vim.keymap.set("x", "<", "<gv", { noremap = true, silent = true, desc = "Indent selected lines to the left and reselect" })
